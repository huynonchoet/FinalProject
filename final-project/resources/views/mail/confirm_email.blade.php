                                                                                    ...
                                                                                    <tr>
                                                                                        <td style='width:130px;'>
                                                                                            <img alt='Profile Picture'
                                                                                                height='auto'
                                                                                                src='https://assets.opensourceemails.com/imgs/oxygen/Ei7o4zRgT561k4rLfzTz_profile_pic.jpg'
                                                                        ...
                                                                        <td align='center'
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <a href='#'
                                                                                    ...
                                                                                    From Your Homestay With Love!!!
                                                                                </a>
                                                                                <span>
                                                                                    <h3>Wellcome to "Your Homestay".
                                                                                    </h3>
                                                                                    <br>
                                                                                    Click the link to confirm the Email
                                                                                    you have registered.
                                                                            ...
                                                                            <table border='0' cellpadding='0'
                                                                                ...
                                                                                <tr>
                                                                                    <td align='center' bgcolor='#ff6f6f'
                                                                                        ...
                                                                                        valign='middle'>
                                                                                        <form method='post'
                                                                                            action='{{ route('confirm-email.update') }}'>
                                                                                            @csrf
                                                                                            @method('PATCH')
                                                                                            <input name='token'
                                                                                                type='hidden'
                                                                                                value='{{ $token }}'>
                                                                                            <button type="submit"
                                                                                                style='background:#ff6f6f;color:#ffffff;border: none;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:400;line-height:21px;margin:0;text-decoration:none;text-transform:none;'
                                                                                                target='_blank'>
                                                                                                Confirm Email
                                                                                            </button>
                                                                                        </form>
